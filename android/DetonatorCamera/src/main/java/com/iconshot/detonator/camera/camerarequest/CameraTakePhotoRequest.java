...
public class CameraTakePhotoRequest extends Request {
    public CameraTakePhotoRequest(Detonator detonator, IncomingRequest incomingRequest) {
    ...
    public void run() {
        ...
        element.takePhoto(new CameraElement.CaptureCallback() {
